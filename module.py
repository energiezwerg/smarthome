        ...
        for module in _conf:
            ...
            if not double:
                try:
                    ...
                    logger.info('Modules: Loaded module {} v{}: {}'.format( str(self._sh._moduledict[classname].__class__.__name__), str(self._sh._moduledict[classname].version), str(self._sh._moduledict[classname].longname) ) )
