...
The detailed release notes can be found in the user documentation under `https://www.smarthomeNG.de/user/release <https://www.smarthomeNG.de/user/release/1_5/>`_
