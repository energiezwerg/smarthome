...
Im folgenden Beispiel werden mehrere zeitbezogene Informationen berechnet. Die Item-Werte können z.B. in Kombination mit dem Datenbank-Plugin und eval-Ausdrücken ("Minuten / Sekunden seit Mitternacht / Beginn des Jahres" usw. genutzt werden.

Daher enthält jedes zeitbezogene Item ein dbstr-Unteritem, welches direkt ein datenbankfähiges Format bereitstellt.

## Beispiel

Im folgenden Beispiel zählt eine Abfrage alle "1" -Werte für das Item **knx.cellar.utility_room.water_meter** im Zeitfenster seit Mitternacht bis jetzt. Eine 1 entspricht hier 1 Liter Wasser. Auf diese Weise kann der Verbrauch seit Mitternacht berechnet werden:
...
Die Logik setzt eine Item Struktur voraus, die weiter unten beschrieben ist.
