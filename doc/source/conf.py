...
#release = '1.3a dev (as of <date>)'  <date> is replaced by makefile with a date in the form of '2. September 2017'
release = '1.3a dev (as of <date>)'
...
exclude_patterns = ['plugins/deprecated_plugins', 'plugins/backend*/static', '**/._*md']
