...
class TestConfig(unittest.TestCase):
	...
	def setUp(self):
		...
		self.plugins = self.sh.with_plugins_from(common.BASE + "/tests/resources/module")

	def test_module_is_registered(self):
		self.assertIsNotNone(self.get_module("mod_http"))

	def test_plugin_not_registered(self):
		self.assertIsNone(self.get_module("mod_httpX"))
